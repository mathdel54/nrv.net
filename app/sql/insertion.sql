...
INSERT INTO "soiree" ("id", "nom", "thematique", "date_heure", "lieu_id", "tarif_normal", "tarif_reduit")
VALUES ('dc4722c7-7fb8-4a21-8b6d-0a567997d874', 'Soiree Rock', 'Rock', '2024-10-28 20:00:00',
        '5277fb17-318b-4a72-b2c7-0bbff48f0aee', 20.00, 12.00),
       ('ee766414-2945-4c8b-9812-c232e14888c7', 'Soiree Sympa', 'Jazz/Classique', '2024-11-15 18:30:00',
        'fb17d7bf-2091-4dec-bd64-cf5dc5266acd', 30.00, 23.00);
...
VALUES ('44533365-fbba-4dd3-865b-1f8af96b3e57', 'Jazz Band Live',
        'Un concert jazz avec les meilleurs musiciens de la ville.', 'https://example.com/jazzband',
        '2024-11-15 21:00:00', 'ee766414-2945-4c8b-9812-c232e14888c7', 'Jazz'),
       ('acc717f5-ced0-4896-89a7-5cd5bca8d669', 'Rock en scène', 'Un groupe de rock pour une soirée mémorable.',
        'https://example.com/rockband', '2024-10-28 20:00:00', 'dc4722c7-7fb8-4a21-8b6d-0a567997d874', 'Rock'),
       ('d8804296-3d11-43c5-92eb-02a087cfb10f', 'Orchestre Symphonique',
        'Gala de musique classique avec un orchestre complet.', 'https://example.com/classique', '2024-11-15 19:30:00',
        'ee766414-2945-4c8b-9812-c232e14888c7', 'Classique');
...
INSERT INTO "users" ("id", "nom", "prenom", "email", "mot_de_passe", "date_enregistrement")
VALUES ('f7c1eba2-7a35-4ca6-9d8b-eaa9636f4070', 'Dupont', 'Jean', 'jean.dupont@example.com', 'password123',
        '2024-10-22 09:36:27.221967'),
       ('a3cd8e39-9dec-4376-a9c8-53356985ba31', 'Martin', 'Marie', 'marie.martin@example.com', 'securepass',
        '2024-10-22 09:36:27.221967'),
       ('1d74c1bf-453c-4417-be0a-5095734e886f', 'Lefevre', 'Luc', 'luc.lefevre@example.com', 'hashme',
        '2024-10-22 09:36:27.221967');
