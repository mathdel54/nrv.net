(() => {
  ...
  var require_runtime = __commonJS({
    "node_modules/handlebars/dist/cjs/handlebars/runtime.js"(exports) {
      ...
      function template6(templateSpec, env) {
        if (!env) {
  ...
  var require_helpers2 = __commonJS({
    "node_modules/handlebars/dist/cjs/handlebars/compiler/helpers.js"(exports) {
      ...
      function SourceLocation(source6, locInfo) {
        this.source = source6;
        this.start = {
  ...
  var require_source_map_generator = __commonJS({
    "node_modules/source-map/lib/source-map-generator.js"(exports) {
      ...
      SourceMapGenerator.prototype.addMapping = function SourceMapGenerator_addMapping(aArgs) {
        ...
        var source6 = util.getArg(aArgs, "source", null);
        var name = util.getArg(aArgs, "name", null);
        if (!this._skipValidation) {
          this._validateMapping(generated, original, source6, name);
        }
        if (source6 != null) {
          source6 = String(source6);
          if (!this._sources.has(source6)) {
            this._sources.add(source6);
          }
        }
        if (name != null) {
          name = String(name);
      ...
      SourceMapGenerator.prototype.setSourceContent = function SourceMapGenerator_setSourceContent(aSourceFile, aSourceContent) {
        var source6 = aSourceFile;
        if (this._sourceRoot != null) {
          source6 = util.relative(this._sourceRoot, source6);
        }
        if (aSourceContent != null) {
          if (!this._sourcesContents) {
            this._sourcesContents = /* @__PURE__ */ Object.create(null);
          }
          this._sourcesContents[util.toSetString(source6)] = aSourceContent;
        } else if (this._sourcesContents) {
          delete this._sourcesContents[util.toSetString(source6)];
      ...
      SourceMapGenerator.prototype.applySourceMap = function SourceMapGenerator_applySourceMap(aSourceMapConsumer, aSourceFile, aSourceMapPath) {
        ...
        this._mappings.unsortedForEach(function(mapping) {
          ...
          var source6 = mapping.source;
          if (source6 != null && !newSources.has(source6)) {
            newSources.add(source6);
          }
      ...
      SourceMapGenerator.prototype._generateSourcesContent = function SourceMapGenerator_generateSourcesContent(aSources, aSourceRoot) {
        return aSources.map(function(source6) {
          if (!this._sourcesContents) {
            return null;
          }
          if (aSourceRoot != null) {
            source6 = util.relative(aSourceRoot, source6);
          }
          var key = util.toSetString(source6);
    ...
    "node_modules/source-map/lib/source-map-consumer.js"(exports) {
      ...
      SourceMapConsumer.prototype.eachMapping = function SourceMapConsumer_eachMapping(aCallback, aContext, aOrder) {
        ...
        mappings.map(function(mapping) {
          var source6 = mapping.source === null ? null : this._sources.at(mapping.source);
          source6 = util.computeSourceURL(sourceRoot, source6, this._sourceMapURL);
          return {
            source: source6,
      ...
      function BasicSourceMapConsumer(aSourceMap, aSourceMapURL) {
        ...
        sources = sources.map(String).map(util.normalize).map(function(source6) {
          return sourceRoot && util.isAbsolute(sourceRoot) && util.isAbsolute(source6) ? util.relative(sourceRoot, source6) : source6;
        });
      ...
      BasicSourceMapConsumer.prototype.originalPositionFor = function SourceMapConsumer_originalPositionFor(aArgs) {
        ...
        if (index >= 0) {
          ...
          if (mapping.generatedLine === needle.generatedLine) {
            var source6 = util.getArg(mapping, "source", null);
            if (source6 !== null) {
              source6 = this._sources.at(source6);
              source6 = util.computeSourceURL(this.sourceRoot, source6, this._sourceMapURL);
            }
      ...
      BasicSourceMapConsumer.prototype.generatedPositionFor = function SourceMapConsumer_generatedPositionFor(aArgs) {
        var source6 = util.getArg(aArgs, "source");
        source6 = this._findSourceIndex(source6);
        if (source6 < 0) {
          return {
            line: null,
            column: null,
      ...
      IndexedSourceMapConsumer.prototype._parseMappings = function IndexedSourceMapConsumer_parseMappings(aStr, aSourceRoot) {
        ...
        for (var i = 0; i < this._sections.length; i++) {
          ...
          for (var j = 0; j < sectionMappings.length; j++) {
            ...
            var source6 = section.consumer._sources.at(mapping.source);
            source6 = util.computeSourceURL(section.consumer.sourceRoot, source6, this._sourceMapURL);
            this._sources.add(source6);
            source6 = this._sources.indexOf(source6);
            var name = null;
            if (mapping.name) {
      ...
      SourceNode.fromStringWithSourceMap = function SourceNode_fromStringWithSourceMap(aGeneratedCode, aSourceMapConsumer, aRelativePath) {
        ...
        function addMappingWithCode(mapping, code) {
          if (mapping === null || mapping.source === void 0) {
            ...
            var source6 = aRelativePath ? util.join(aRelativePath, mapping.source) : mapping.source;
  ...
  var require_code_gen = __commonJS({
    "node_modules/handlebars/dist/cjs/handlebars/compiler/code-gen.js"(exports, module) {
      ...
      CodeGen.prototype = {
        ...
        prepend: function prepend(source6, loc) {
          this.source.unshift(this.wrap(source6, loc));
        },
        push: function push(source6, loc) {
          this.source.push(this.wrap(source6, loc));
        },
        merge: function merge() {
          var source6 = this.empty();
  ...
  var require_javascript_compiler = __commonJS({
    "node_modules/handlebars/dist/cjs/handlebars/compiler/javascript-compiler.js"(exports, module) {
      ...
      JavaScriptCompiler.prototype = {
        ...
        appendToBuffer: function appendToBuffer(source6, location, explicit) {
          if (!_utils.isArray(source6)) {
            source6 = [source6];
          }
          source6 = this.source.wrap(source6, location);
          if (this.environment.isSimple) {
            return ["return ", source6, ";"];
          } else if (explicit) {
            return ["buffer += ", source6, ";"];
          } else {
            source6.appendToBuffer = true;
            return source6;
          }
        },
        ...
        createFunctionContext: function createFunctionContext(asObject) {
          ...
          var source6 = this.mergeSource(varDeclarations);
          if (asObject) {
            params.push(source6);
        ...
        pushSource: function pushSource(source6) {
          if (this.pendingContent) {
            this.source.push(this.appendToBuffer(this.source.quotedString(this.pendingContent), this.pendingLocation));
            this.pendingContent = void 0;
          }
          if (source6) {
            this.source.push(source6);
          }
        },
  ...
  function modifierNbPlaces(index, nbPlaces) {
  ...
  function modifierTarif(index, tarif) {
  ...
  import_handlebars4.default.registerHelper("ifCond", function(v1, v2, options) {
    if (v1 == v2) {
      return options.fn(this);
    }
    return options.inverse(this);
  ...
  // js/mesBilletsLoader.js
  function loadBillets() {
    return __async(this, null, function* () {
      if (sessionStorage.getItem("user_id") === null) {
        return;
      }
      return yield load("/users/" + sessionStorage.getItem("user_id") + "/billets");
    });
  }

  // js/mesBillets_ui.js
  var source5 = document.getElementById("mesBilletsTemplate").innerHTML;
  var template5 = import_handlebars5.default.compile(source5);
